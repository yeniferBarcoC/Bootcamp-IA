...
print("\n---------------INDICE Y ACCESO A LOS ELEMENTOS DE LA LISTA:------------------- ")
...
# funcion extend()
pokemones_de_ash.extend(["Pidgeot","Rattata"])
print("\n---------------EXTENDER UNA LISTA CON OTRA:------------------- \n",pokemones_de_ash)

#------------------------------------------Página 6---------------------------------------------
# Slicing (Rebanado): Se puede ontener un pedazo de la lista mediante el uso de slicing
sublista = pokemones_de_ash[1:3]
print("\n---------------Slicing (Rebanado):------------------- \n",sublista)

# Inclusión de elementos: se puede verificar si un elemento se encuentra en una lista con el
# operador in
